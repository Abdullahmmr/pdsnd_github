...
def main():
    while True:
        ...
        index = 0
        while True:
          choice = input("Do you want to see 5 lines of dataframe [yes/no]: ")
          if choice != "no":
            print(df.iloc[index:index+5])
            index += 5
          else:
            break
          # Done. you can copy this. It will ask for whether user wants to see 5 lines of df
          # if user presses yes it will display 5 lines. It will keep on asking and displaying until user enters no
